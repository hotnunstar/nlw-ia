        ...
        <aside className='w-80 space-y-6'>
          <form className='space-y-6'>
            ...
            <div className="space-y-2">
              ...
              <Textarea id="transcription-prompt" className='h-20 leading-relaxed resize-none' placeholder='Inclua as palavras-chave mencionadas no vídeo separadas por vírgula (,)'></Textarea>
            </div>
